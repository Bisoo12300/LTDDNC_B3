    ...
    <View style={tw`${otherStyles} `}>
      <Animated.View
        ...
        style={[
          ...
          tw`flex flex-row items-center justify-center rounded-xl w-full h-[72px] px-4 bg-[#F3F3F3] border-2 border-[#A8A8A9] focus:border-black-200 ${
      ...
      >
        ...
        <Image
          ...
          style={tw`w-8 h-8 mr-1 bg-b`}
          resizeMode="contain"
        />
        {/* TextInput */}
        <TextInput
          style={tw`flex-1 text-black-100 font-semibold text-lg`}
          value={value}
      ...
      {error && (
        <Animated.View style={tw`text-red-500 font-pregular text-sm mt-3 self-center`}>
          <Text>{error}</Text>
        </Animated.View>
      )}
    </View>
